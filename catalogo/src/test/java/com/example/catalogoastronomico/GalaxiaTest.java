...
public class GalaxiaTest {
   ...
   @Test
   public void setters() {
      Galaxia a = new Galaxia("a", -1.42, 8.7);
      a.setNombre("nuevo");
      a.setBrillo(-2.6);
      a.setDistancia(4.5);
   ...
   public void equals_esCorrecto() {
      Galaxia a = new Galaxia("a", -1.42, 8.7);
      Galaxia b = new Galaxia("a", -1.42, 8.7);
      Galaxia c = new Galaxia("a", -1.42, 8.8);
   ...
   public void masDistante() {
      Galaxia a = new Galaxia("a", -1.42, 8.7);
      Galaxia b = new Galaxia("b", -1.42, 8.8);
   ...
   public void masBrillo() {
      Galaxia a = new Galaxia("a", -1.42, 8.7);
      Galaxia b = new Galaxia("b", -1.43, 8.7);
      Galaxia c = new Galaxia("c", -1.43, 8.7);
   ...
   public void visibleCon() {
      Galaxia a = new Galaxia("a", 4.5, 8.7);
